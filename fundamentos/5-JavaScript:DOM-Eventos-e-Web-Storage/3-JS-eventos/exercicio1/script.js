...
// R - por causa da funcao translateY, que reposiciona o elemento de acordo com o parametro passado
...
myWebpage.addEventListener('dblclick', function(event){
  window.location.replace('https://www.github.com/LPRaphael/');
});

// 5. Crie uma função que, ao passar o mouse sobre 'Meu top 3 do Spotrybefy', altere
// a cor do mesmo;
myWebpage.addEventListener('mouseover', function (event){
  event.target.style.color = '#' + Math.floor(Math.random() * 16777215);
});
